...
- 当前阶段：**P3 代码交付完成，等待用户试玩验收**。已补充燃烧反馈，并接入地图、机制敌人及最终 Boss 纵向样板；内容与检查记录见 [P3_DELIVERY.md](P3_DELIVERY.md)。实际手感与完整对局待用户试玩，P4 尚未开始。
...
第 6～10 层的新地图、房间和怪物专项设计见 [失控铸造所设计](FLOORS_06_10_DESIGN.md)。该方案目前处于设计状态，以四步灰盒交付推进，每步完成后试玩验收；不将文档中的新机制视为已实现。
