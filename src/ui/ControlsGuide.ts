const DESKTOP = [
  ...
  ['召唤编队', '亡者编队不需要先击杀敌人即可召唤战士、守卫和射手。G 集火瞄准方向的敌人，H 召回；手机点击编队按钮。召回不会补血，灵魂献祭会消耗一只单位，容量与四个技能槽独立。'],
  ['遗迹与圣陵', '补给架沿用交互操作，开启后可走捷径。军械挑战和无名者安葬均自愿开启，清理后再交互领奖。圣陵双叩会在原地再打一次；追踪印记落定后离开，飞刃原路往返。葬仪台的青色范围只伤敌人，每台一次；司钟人的葬印可放到外侧刻槽制造输出窗口。'],
  ['铸造所机制', '蓝青色贴地震波可跳过，也可走缺口；喷汽与射线不能靠跳跃免疫。引导撞锤兽撞裂纹隔板，命中铸链师打断供能。第九层金色装置是自愿试炼，靠近交互启动，清理后可选择奖励。'],
...
const MOBILE = [
  ...
  ['攻击与技能', '点按攻击键出手，短拖后松手按选定方向攻击，直接长按可连续攻击。按住技能键拖动瞄准，松手施放；拖远至出现“松手取消”后松开即可取消，拖回可继续瞄准。第一人称拖动会偏移屏幕准星，远程攻击可调整高低；第三人称支持周身方向瞄准。左手可同时移动。技能受法力与冷却限制，自身范围技能仍以角色为中心。'],
  ['召唤编队', '亡者编队不需要先击杀敌人即可召唤战士、守卫和射手。G 集火瞄准方向的敌人，H 召回；手机点击编队按钮。召回不会补血，灵魂献祭会消耗一只单位，容量与四个技能槽独立。'],
  ['遗迹与圣陵', '补给架沿用交互操作，开启后可走捷径。军械挑战和无名者安葬均自愿开启，清理后再交互领奖。圣陵双叩会在原地再打一次；追踪印记落定后离开，飞刃原路往返。葬仪台的青色范围只伤敌人，每台一次；司钟人的葬印可放到外侧刻槽制造输出窗口。'],
  ['铸造所机制', '蓝青色贴地震波可跳过，也可走缺口；喷汽与射线不能靠跳跃免疫。引导撞锤兽撞裂纹隔板，命中铸链师打断供能。第九层金色装置是自愿试炼，靠近交互启动，清理后可选择奖励。'],
  ['探索与交互', '靠近交互物后，点击交互按钮执行提示的操作。点击眼睛与环形箭头按钮切换视角；第三人称在场景空白处双指张开放大、合拢拉远镜头，操作按键上的触摸不参与缩放。'],
  ...
  ['技能配置与暂停', '点击“技能”按钮调整技能槽（横屏底部，竖屏右侧）；点击小地图左侧的暂停按钮打开菜单，可调整灵敏度、自动回正和震动强度；在“操控”中点击“自定义按键位置”可拖动按键，横竖屏分别保存，也可恢复默认布局。使用面板关闭按钮或手机返回操作返回上一层。'],
