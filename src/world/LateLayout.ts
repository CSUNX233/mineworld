...
export function createLateLayout(rng:RNG,floor:number):MapLayout {
  ...
  if(floor%5===0)return {kind:'branch-rejoin',nodes:[node(7,'start',9,24),node(3,'sanctuary',25,24),node(4,'battle',44,24,true),node(1,'exit',72,24,true),node(5,'treasure',25,43)],edges:[['room-7','room-3'],['room-3','room-4'],['room-4','room-1'],['room-3','room-5']]};
